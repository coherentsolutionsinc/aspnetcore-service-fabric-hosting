    ...
    public class ServiceManifest
    {
            ...
            ServiceManifestElement element)
        {
            ...
            this.codePackages = new CodePackageCollection(
                ReadPackages(element.CodePackages, new CodePackageFactory()));

            this.configPackages = new ConfigPackageCollection(
                ReadPackages(element.ConfigPackages, new ConfigPackageFactory()));

            this.dataPackages = new DataPackageCollection(
                ReadPackages(element.DataPackages, new DataPackageFactory()));
